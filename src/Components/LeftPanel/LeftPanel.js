...
import { faBowlFood, faHotel, faCamera, faFan, faPalette, faHandSparkles, faUser } from '@fortawesome/free-solid-svg-icons'
        ...
        <div id="" className="leftPanel overflow-auto">
            <div className='overflow-y-auto mx-xl-2'>
                <div className="menu-item mt-3">
                    <div className="menu-content pb-2 text-hover-dark">
                ...
                {services.map((service, index) => {
                    return (
                        // <div 
                        // ref={menuItem.current[index]} id={service.name} className={`menu-item py-1 mx-2 mx-md-3 mb-4 ${service.name == 'Venues' ? 'clicked' : ''}`} key={index} onClick={() => servicesClickHandler(service.name)}>
                ...
                <div data-kt-menu-trigger="click" className="menu-item menu-accordion mb-1">
                    <span className="menu-link">
                        <span className="menu-icon">
                            <span className="iconColor svg-icon-2">
